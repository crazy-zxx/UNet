...
class UNet(nn.Module):
    def __init__(self, n_channels, n_classes):
        ...
        self.up1 = nn.ConvTranspose3d(in_channels=512, out_channels=512, kernel_size=2, stride=2, padding=0)
        self.right_conv1 = DoubleConvRight(in_channels=256+512, out_channels=256)
        self.up2 = nn.ConvTranspose3d(in_channels=256, out_channels=256, kernel_size=2, stride=2, padding=0)
        self.right_conv2 = DoubleConvRight(in_channels=128+256, out_channels=128)
        self.up3 = nn.ConvTranspose3d(in_channels=128, out_channels=128, kernel_size=2, stride=2, padding=0)
        self.right_conv3 = DoubleConvRight(in_channels=64+128, out_channels=64)
