...
class UNet(nn.Module):
    def __init__(self, n_channels, n_classes):
        ...
        self.up1 = nn.ConvTranspose3d(in_channels=1024, out_channels=512, kernel_size=2, stride=2, padding=0)
        self.right_conv1 = DoubleConv(in_channels=1024, out_channels=512)
        self.up2 = nn.ConvTranspose3d(in_channels=512, out_channels=256, kernel_size=2, stride=2, padding=0)
        self.right_conv2 = DoubleConv(in_channels=512, out_channels=256)
        self.up3 = nn.ConvTranspose3d(in_channels=256, out_channels=128, kernel_size=2, stride=2, padding=0)
        self.right_conv3 = DoubleConv(in_channels=256, out_channels=128)
        self.up4 = nn.ConvTranspose3d(in_channels=128, out_channels=64, kernel_size=2, stride=2, padding=0)
